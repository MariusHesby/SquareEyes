const filmsRecommendations = document.querySelector(".recommendations");
const filmsTopGrossing = document.querySelector(".topGrossing");
...
async function getMovies() {
  try {
    ...
    console.log(results);
    filmsRecommendations.innerHTML = "";
    ...
    for (let i = 0; i < results.length; i++) {
      ...
      filmsRecommendations.innerHTML += `
                                ...
                                <div>
                                  ...
                                  <p><i class="fas fa-coins"></i><span class="currency">3.2 NOK</span></p>
                                  <p>
